...
import { FaMapMarkerAlt, FaEnvelope, FaPhone, FaFacebook, FaInstagram, FaTwitter, FaWhatsapp } from "react-icons/fa";
                        ...
                        <div>
                            ...
                            <form onSubmit={handleSubmit} className="flex gap-2">
                                <input
                                    ...
                                    required
                                    className="px-4 py-2 rounded text-white flex-1 border border-white focus:ring-2 focus:ring-accent focus:border-accent focus:outline-none"
                                />
                                <button 
                                    type="submit"
